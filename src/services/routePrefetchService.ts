...
const PREFETCH_MAP: Partial<Record<NavigationView, () => Promise<unknown>>> = {
    ...
    qualityInsights: () => import("@/pages/AnalyticsHubPage"),
    projects: () => import("@/pages/ProjectListPage"),
    projectDetail: () => import("@/pages/ProjectDetailPage"),
    createProject: () => import("@/pages/CreateProjectWizard"),
    editProject: () => import("@/pages/CreateProjectWizard"),
    ...
    trainingDetail: () => import("@/pages/TrainingDetailPage"),
    ...
    workflowAutomation: () => import("@/pages/WorkflowAutomationPage"),
    reportBuilder: () => import("@/pages/ReportBuilderPage"),
    supplierHub: () => import("@/pages/SupplierHubPage"),
    changeControlHub: () => import("@/pages/ChangeControlHubPage"),
    templateLibrary: () => import("@/pages/TemplateLibraryPage"),
    mockSurvey: () => import("@/components/projects/SurveyComponent"),
