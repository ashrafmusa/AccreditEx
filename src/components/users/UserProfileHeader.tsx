...
import { CheckCircleIcon, UserCircleIcon, PencilIcon } from '../icons';
...
const UserProfileHeader: React.FC<Props> = ({ user, department, isOwnProfile = false, onEditClick }) => {
        ...
        <div className="relative p-8">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                ...
                <div className="relative">
                    <UserAvatar user={user} size="xl" showStatus ariaLabel={`${user.name} profile picture`} />
                ...
                <div className="flex-1">
                    ...
                    <div className="flex flex-wrap items-center gap-2 mb-3">
                        <p className="text-blue-100 font-semibold">{user.jobTitle || user.role}</p>
                        {isOwnProfile && (
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 rounded-lg shadow">
                    ...
                    <span className="text-sm font-medium text-gray-900 dark:text-white">{t('active') || 'Active'}</span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-8 pt-8 border-t border-white/20">
                ...
                <StatBox label={t('department')} value={department?.name[lang] || t('unassigned')} />
                <StatBox label={t('hireDate')} value={user.hireDate ? new Date(user.hireDate).toLocaleDateString() : 'N/A'} />
