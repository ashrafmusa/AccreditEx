...
import { SearchIcon, ClipboardDocumentListIcon } from "../icons";
...
const DepartmentTaskTable: React.FC<DepartmentTaskTableProps> = ({
  tasks,
  users,
}) => {
              ...
              return (
                ...
                >
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    >
                      {statusInfo[task.status]?.text || task.status}
                    </span>
                  </td>
                  <td className="px-6 py-4">
                    ...
                    <p className="text-xs text-brand-text-secondary dark:text-dark-brand-text-secondary">
                      {t("standard")}: {task.standardId}
                    </p>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm">
                    {assignedUser?.name || t("unassigned")}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm">
                    {task.projectName}
                  </td>
