...
const EffectivenessChecksTab: React.FC<Props> = ({
  projects,
  onUpdateCapa,
}) => {
  const { t, dir } = useTranslation();
  const [completingCheck, setCompletingCheck] = useState<
    (CAPAReport & { projectId: string }) | null
  >(null);
          ...
          >
            <div className="p-6">
              <h3 className="text-lg font-medium">
                {t("completeEffectivenessCheck")}
              </h3>
              <p className="text-sm text-gray-500 mt-1">
                {completingCheck.sourceStandardId}
              </p>
              <div className="mt-4">
                <label
            ...
            <div className="bg-gray-50 dark:bg-gray-800 px-4 py-3 flex justify-end gap-3">
              ...
              <button
                ...
                className="py-2 px-4 border rounded-md text-sm text-white bg-brand-primary"
              >
                {t("save")}
              </button>
            </div>
