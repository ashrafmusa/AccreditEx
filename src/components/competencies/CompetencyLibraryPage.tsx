        ...
        <div className="flex items-center space-x-3 rtl:space-x-reverse self-start">
          ...
          <div>
            ...
            <p className="text-brand-text-secondary dark:text-dark-brand-text-secondary mt-1">
              {t("competencyLibraryDescription")}
            </p>
          </div>
        </div>
        <button
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-dark-brand-border">
            <thead className="bg-gray-50 dark:bg-gray-700">
              <tr>
                ...
                <th
                  scope="col"
                  className="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider rtl:text-left"
                >
                  {t("actions")}
                </th>
              </tr>
