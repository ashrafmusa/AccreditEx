...
const ProcessMapMetadataModal: React.FC<ProcessMapMetadataModalProps> = ({
  isOpen,
  onClose,
  onSave,
}) => {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="process-map-modal-title"
    >
      <div
      ...
      >
        <form onSubmit={handleSubmit}>
          <div className="p-6">
            <h3 id="process-map-modal-title" className="text-lg font-medium">
