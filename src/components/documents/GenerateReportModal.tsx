        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-medium text-brand-text-primary dark:text-dark-brand-text-primary">
                {t("generateReport")}
              </h3>
            </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4">
              <div className="flex items-start gap-2">
                <DocumentTextIcon className="w-5 h-5 text-blue-600 dark:text-blue-400 mt-0.5 shrink-0" />
                <div className="text-sm text-blue-800 dark:text-blue-200">
                  <p className="font-medium mb-1">
                    Professional PDF Report with AI Analysis
                  </p>
                  <p className="text-blue-700 dark:text-blue-300">
                    Generate a comprehensive, professionally formatted PDF
                    report using AI analysis of your project's compliance data,
                    CAPA reports, and evidence documentation. The report
                    includes charts, tables, and strategic recommendations. It
                    will be automatically saved to Document Control and
            ...
            <div className="mt-4">
              ...
              >
                <option value="complianceSummary">
                  {t("complianceSummaryReport")}
                </option>
                <option value="detailedCompliance">
                  Detailed Compliance Report
                </option>
                <option value="executiveSummary">Executive Summary</option>
                <option value="capaAnalysis">CAPA Analysis Report</option>
                <option value="assessorPack">
                  Assessor Evidence Pack (JSON + CSV)
                </option>
              </select>
              <p className="mt-2 text-xs text-gray-600 dark:text-gray-400">
                Generation typically takes 30-60 seconds depending on project
                complexity.
              </p>
            </div>
          </div>
