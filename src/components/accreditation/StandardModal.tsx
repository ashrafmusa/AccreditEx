...
import { Standard, StandardCriticality, SubStandard, StandardDocument } from '@/types';
...
const StandardModal: React.FC<StandardModalProps> = ({ isOpen, onClose, onSave, existingStandard }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={isEditMode ? t('editStandard') : t('addStandard')} footer={footer} size="2xl">
      <form id="standard-form" onSubmit={handleSubmit} className="space-y-4 max-h-96 overflow-y-auto">
        <div>
        ...
        {isEditMode && currentUser && (
          <div className="pt-4 border-t dark:border-gray-600">
            ...
            >
              {showDocuments ? '▼' : '▶'} {t('guideDocuments') || 'Guide Documents'} ({documents.length})
            </button>
            {showDocuments && (
