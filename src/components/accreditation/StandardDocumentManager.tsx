...
interface StandardDocumentManagerProps {
  ...
  userId: string;
  canModify: boolean;
  onDocumentsChange: (documents: StandardDocument[]) => void;
}

const StandardDocumentManager: React.FC<StandardDocumentManagerProps> = ({
  standardId,
  documents,
  userId,
  canModify,
...
export default StandardDocumentManager;
