...
const AuditPlanModal: FC<AuditPlanModalProps> = ({
  isOpen,
  onClose,
  onSave,
  existingPlan,
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6">
            <h3 className="text-lg font-medium">
              {isEditMode ? t("editAuditPlan") : t("newAuditPlan")}
            </h3>
            <div className="mt-4 space-y-4">
              <div>
                <label className={labelClasses}>{t("planName")}</label>
                <input
                  type="text"
                  value={name}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className={labelClasses}>{t("frequency")}</label>
                  <select
                    value={frequency}
                ...
                <div>
                  <label className={labelClasses}>{t("itemsToAudit")}</label>
                  <input
                    type="number"
                    min="1"
                    value={itemCount}
              ...
              <div>
                <label className={labelClasses}>{t("assignAuditor")}</label>
                <select
