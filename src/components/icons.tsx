...
const iconPaths = {
  ...
  SparklesIcon: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.562L16.25 21.75l-.648-1.188a2.25 2.25 0 00-1.49-1.49L12.75 18.75l1.188-.648a2.25 2.25 0 001.49-1.49l.648-1.188.648 1.188a2.25 2.25 0 001.49 1.49l1.188.648-1.188.648a2.25 2.25 0 00-1.49 1.49z"
    />
  ),
  PaperClipIcon: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M18.375 12.739l-7.693 7.693a4.5 4.5 0 01-6.364-6.364l10.94-10.94A3.375 3.375 0 1119.5 7.372L8.552 18.32m.009-.01l-.01.01m5.699-9.941l-7.687 7.687a1.125 1.125 0 01-1.591-1.591l7.687-7.687a1.125 1.125 0 011.591 1.591z"
    />
  ),
  ...
  ClipboardDocumentSearchIcon: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9 12h6m-6 4h6m2.25-4h.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 01-2.25 2.25H6.75A2.25 2.25 0 014.5 18V6.75c0-.621.504-1.125 1.125-1.125h.375m12.158 3.842l-3.328-3.328A2.25 2.25 0 0012.158 6H9"
    />
  ),
  BeakerIcon: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9.75 3.104v5.714a2.25 2.25 0 01-.21 1.002L7.5 15.25l-2.04-5.426a2.25 2.25 0 01-.21-1.002V3.104a2.25 2.25 0 012.25-2.25h1.5a2.25 2.25 0 012.25 2.25zM15 3.75a2.25 2.25 0 012.25 2.25v11.25a2.25 2.25 0 01-2.25 2.25h-9a2.25 2.25 0 01-2.25-2.25V6a2.25 2.25 0 012.25-2.25m9 0h-9"
    />
  ),
  ShieldCheckIcon: (
    <path
  ...
  Cog6ToothIcon: (
    <>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M10.5 6h3m-6.75 3h13.5M3.75 12h16.5m-16.5 3H12m-8.25 3h13.5"
  ...
  AcademicCapIcon: (
    <>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0l-3.376 3.376a59.942 59.942 0 003.376-3.376z"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M6.25 10.399a48.567 48.567 0 01-2.658-.813m15.482 0a48.567 48.567 0 00-2.658-.813M12 21.75V3.493"
      />
    </>
  ),
  ChartBarSquareIcon: (
  ...
  LightBulbIcon: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311a2.4 2.4 0 01-3.75 0M14.25 18v-5.25m0 0a6.01 6.01 0 00-1.5-.189m1.5.189a6.01 6.01 0 011.5-.189m-3.75 7.478a12.06 12.06 0 014.5 0M12 4.5a3.75 3.75 0 00-3.75 3.75v1.5a3.75 3.75 0 007.5 0v-1.5A3.75 3.75 0 0012 4.5z"
    />
  ),
  PencilIcon: (
    <path
  ...
  BuildingOffice2Icon: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12M6.75 3v.75m.75-.75v.75m-.75 0h.75m5.25 0h.75m-.75 0v.75m.75-.75v.75M9 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M9 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21m-4.5 0H9"
    />
  ),
  CheckBadgeIcon: (
    <path
  ...
  BellIcon: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.31 5.632l-.01.012a23.848 23.848 0 005.454 1.31M15 17.25a3 3 0 01-6 0m4.5 0a9 9 0 00-9 0"
    />
  ),
  EyeIcon: (
    <>
  ...
  SpinnerIcon: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-11.667-11.667l3.181 3.183A8.25 8.25 0 0118.015 15a8.25 8.25 0 01-11.667 0l-3.181-3.183"
    />
  ),
  IdentificationIcon: (
    <path
  ...
  DiamondIcon: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.324H21a.563.563 0 01.324.96l-4.218 3.065a.563.563 0 00-.182.635l1.601 4.887a.563.563 0 01-.84.635L12 18.066a.563.563 0 00-.656 0l-4.218 3.065a.563.563 0 01-.84-.635l1.601-4.887a.563.563 0 00-.182-.635L2.676 13.06a.563.563 0 01.324-.96h5.882a.563.563 0 00.475-.324L11.48 3.5z"
      transform="rotate(45 12 12) scale(0.9)"
    />
  ),
  PauseCircleIcon: (
    <path
  ...
  DocumentIcon: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9 12h3.75M9 15h3.75M9 18h3.75m3-11.25V6a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 6v12a2.25 2.25 0 002.25 2.25h13.5A2.25 2.25 0 0021 18V9.75"
    />
  ),
  CogIcon: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15 0a7.5 7.5 0 1115 0m-15 0H3"
    />
  ),
  ServerStackIcon: (
    <>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M6.75 21H3a2.25 2.25 0 01-2.25-2.25V5.25A2.25 2.25 0 013 3h18a2.25 2.25 0 012.25 2.25v13.5A2.25 2.25 0 0121 21h-3.75m-10.5 0V12.75m10.5 0V21"
      />
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 6.75h.75" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 9.75h.75" />
    </>
  ),
  PaintBrushIcon: (
    <path
  ...
  BoldIcon: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M6 12h9m-9-6h9m-9 12h9m-7.5-9v6m0-6H6m1.5 0h1.5m0 6H7.5m1.5 0H6"
    />
  ),
  ItalicIcon: (
    <path
  ...
  UnderlineIcon: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M6 21h12M8 3v9a4 4 0 008 0V3"
    />
  ),
  StrikethroughIcon: (
    <path
  ...
  ListNumberIcon: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M8.242 5.992h12m-12 6.003H20.24m-12 5.999h12M4.117 7.495v-3.75H2.99m1.125 3.75H2.99m1.125 0H5.24m-1.92 2.577a1.125 1.125 0 011.591 1.59l-1.83 1.83h2.16M2.99 15.745h1.125a1.125 1.125 0 010 2.25H3.74m0-.002h.375a1.125 1.125 0 010 2.25H2.99"
    />
  ),
  QuoteIcon: (
    <path
  ...
  CubeIcon: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M21 7.353v9.294a.75.75 0 01-.354.636l-9 5.25a.75.75 0 01-.792 0l-9-5.25A.75.75 0 011.5 16.647V7.353a.75.75 0 01.354-.636l9-5.25a.75.75 0 01.792 0l9 5.25a.75.75 0 01.354.636zM12 21v-9.75m0 0L3 6.75m9 4.5l9-4.5"
    />
  ),
  FlagIcon: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M3 3v1.5M3 21v-6m0-9l18 0m-3 2.818l-3.182-1.454m-4.364 1.454L12 10.5M8.25 10.5h2.25M3 13.5h2.25M3 19.5h2.25"
    />
  ),
  ArchiveBoxIcon: (
    <path
...
export const BriefcaseIcon = createOutlineIcon(iconPaths.BriefcaseIcon);
// --- Alias Icons ---
