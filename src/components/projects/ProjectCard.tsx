...
import { PencilIcon, TrashIcon, ExclamationTriangleIcon, ClipboardDocumentCheckIcon, CheckIcon } from '../icons';
          ...
          <div className="mt-4 pt-4 border-t border-brand-border dark:border-dark-brand-border flex justify-between items-end">
            <div>
              ...
              <div className="flex -space-x-2 rtl:space-x-reverse">
                  {project.teamMembers.slice(0, 4).map(member => <UserAvatar key={member.id} user={member} size="sm" ariaLabel={member.name} />)}
