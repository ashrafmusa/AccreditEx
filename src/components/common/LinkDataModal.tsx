...
const mockFhirResources = [
  {
    ...
    resourceId: "obs-123",
    displayText: "Lab Result: Hemoglobin A1c - 7.2%",
  },
  {
    resourceType: "MeasureReport",
    resourceId: "mr-456",
    displayText: "Quality Metric: Hand Hygiene Compliance - 98%",
  },
  {
    resourceType: "DocumentReference",
    resourceId: "doc-789",
    displayText: "Policy: Patient Identification v3.0",
  },
  {
    resourceType: "Immunization",
    resourceId: "imm-101",
    displayText: "Vaccination Record: Influenza",
  },
  {
    resourceType: "MedicationAdministration",
    resourceId: "med-212",
    displayText: "Medication Event: Warfarin Administered",
  },
];
...
const LinkDataModal: React.FC<LinkDataModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-brand-surface dark:bg-dark-brand-surface rounded-lg shadow-xl w-full max-w-lg m-4 modal-content-enter border border-brand-border dark:border-dark-brand-border"
      ...
      >
        ...
        <div className="bg-gray-50 dark:bg-gray-900/50 px-4 sm:px-6 py-3 flex justify-end rounded-b-lg">
          <button
            type="button"
            onClick={onClose}
            className="bg-white dark:bg-gray-600 py-2 px-4 border border-gray-300 dark:border-gray-500 rounded-md text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-500"
          >
            {t("cancel")}
          </button>
        </div>
