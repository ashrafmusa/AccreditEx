...
const ConfirmationModal: FC<ConfirmationModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-brand-surface dark:bg-dark-brand-surface rounded-lg shadow-xl w-full max-w-lg m-4 modal-content-enter"
            ...
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-3 text-center sm:mt-0 ltr:sm:ml-4 rtl:sm:mr-4 sm:text-left">
                <h3
                  ...
                  className="text-lg leading-6 font-semibold text-brand-text-primary dark:text-dark-brand-text-primary"
                >
                  {title}
                </h3>
                <div className="mt-2">
...
const SanitizedPrompt: React.FC<{ text: string }> = ({ text }) => {
