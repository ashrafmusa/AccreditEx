...
const GlobeSettingsPage: React.FC = () => {
    ...
    const handleColorChange = (field: 'baseColor' | 'markerColor' | 'glowColor', color: string) => {
    ...
    return (
        <div className="space-y-6">
            <SettingsCard
                ...
                description={t('globeSettingsDescription') || 'Configure the appearance and behavior of the interactive globe'}
                footer={
                    <button 
                        onClick={handleSave} 
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                                        {t('baseColorDescription') || 'The primary background color of the globe'}
                                    </p>
                                    <ColorPicker 
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                                        {t('markerColorDescription') || 'The color of location markers on the globe'}
                                    </p>
                                    <ColorPicker 
                                        color={globe.markerColor} 
                                        onChange={(color) => handleColorChange('markerColor', color)} 
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                                        {t('glowColorDescription') || 'The color of the glowing effect around the globe'}
                                    </p>
                                    <ColorPicker 
                        ...
                        <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                                        {t('rotationSpeedDescription') || 'How fast the globe rotates'}
                                    </p>
                                    <div className="flex items-center gap-3">
                                        <input 
                                            ...
                                            className="flex-1"
                                        />
                                        <span className="text-sm font-medium w-16">{globe.rotationSpeed.toFixed(2)}</span>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <input 
                                            ...
                                            className="flex-1"
                                        />
                                        <span className="text-sm font-medium w-16">{globe.scale.toFixed(1)}x</span>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                                        {t('darknessDescription') || 'How dark the globe background is'}
                                    </p>
                                    <div className="flex items-center gap-3">
                                        <input 
                                            type="range" 
                                            ...
                                            onChange={(e) => handleSliderChange('darkness', parseFloat(e.target.value))}
                                            className="flex-1"
                                        />
                                        <span className="text-sm font-medium w-16">{(globe.darkness * 100).toFixed(0)}%</span>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                                        {t('lightIntensityDescription') || 'The brightness of light on the globe'}
                                    </p>
                                    <div className="flex items-center gap-3">
                                        <input 
                                            type="range" 
                                            ...
                                            className="flex-1"
                                        />
                                        <span className="text-sm font-medium w-16">{globe.lightIntensity.toFixed(1)}x</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="sticky top-8">
                            ...
                            <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                                <p className="text-xs text-blue-700 dark:text-blue-300">
                                    {t('globePreviewInfo') || 'Changes are reflected in real-time. Adjust the sliders and color pickers to customize the globe appearance.'}
                                </p>
                            </div>
                        </div>
                    </div>
