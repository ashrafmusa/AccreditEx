...
import { getChartTheme, CHART_ANIMATION } from "@/utils/chartTheme";
...
const KpiCard: FC<KpiCardProps> = ({
  ...
  return (
    <div className="bg-brand-surface dark:bg-dark-brand-surface p-5 rounded-xl shadow-lg border border-brand-border dark:border-dark-brand-border flex flex-col justify-between transition-all hover:shadow-xl hover:-translate-y-1">
        ...
        <div className="w-20 h-20 -mt-4 -mr-2">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              />
              <RadialBar
                background={{ fill: ct.isDark ? "#334155" : "#e2e8f0" }}
                dataKey="value"
                cornerRadius={10}
                fill={color}
                angleAxisId={0}
      ...
      <div className="-mt-12">
        <p className="text-4xl font-bold text-brand-text-primary dark:text-dark-brand-text-primary">
          {value}
          <span className="text-2xl text-brand-text-secondary dark:text-dark-brand-text-secondary">
            %
          </span>
        </p>
