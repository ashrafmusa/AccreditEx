...
const HeaderActions: React.FC<HeaderActionsProps> = ({ onOpenCommandPalette }) => {
    ...
    return (
        <>
            ...
            <button onClick={toggleTheme} className="text-brand-text-secondary dark:text-dark-brand-text-secondary hover:text-brand-primary-600 dark:hover:text-white p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800" aria-label={t('toggleTheme')}>
